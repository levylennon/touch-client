function(e, t, i) {
    function n() {
        r.call(this, "div", { className: "ChallengeIndicator", hidden: !0 }), c(this, { isCollapsable: !0, title: langModule("ui.common.challenges"), small: !0 }),
    ...
    i(569);
    var o = i(54).dimensions,
        a = i(56).inherits,
        r = i(72),
        s = i(453),
        c = i(570),
        langModule = i(17).getText,
        d = i(572),
        u = i(12),
        connection = i(105),
        h = i(86),
    ...
    n.prototype._hookupEvents = function(e) {
        ...
        this.rerollButton.on("tap", function() {
            var e = t.rerollPrice,
                i = langModule("ui.popup.challengeRerollWarning", b(e));
            return 0 === e ? void t.rerollButton.disable() : void window.gui.openConfirmPopup({
                title: langModule("ui.popup.warning"),
                message: i,
                cb: function(e) {
    ...
    n.prototype.getDescriptionWithFighter = function(e, t) {
        ...
        if (i) {
            var n = i.name + " (" + langModule("ui.common.level") + " " + i.level + ")";
    ...
    n.prototype.setChallenge = function(e, t) {
        ...
        u.preloadImage("gfx/challenges/" + e._gfxId + ".png", function(c) {
            ...
            p || (Logger.log("Cannot find an available slot... creating one..."), i._createChallengeSlot({
                isAchievement: !1
            }),
            p = i._searchForAnEmptySlot(n)),
            d = p.icon,
