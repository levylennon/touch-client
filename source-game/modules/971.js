function(e, t, i) {
    ...
    a(n, r), e.exports = n, n.prototype._setupDom = function() {
        ...
        function e(e) {
            "3vs3" === e._type && (o._ladder.updatePageCount(e.ladderResult.total_characters_count), o._ladder.updateLadderData(e.ladderResult.characters), c.setTopPlayersDisplay3v3(o._ladder, e.ladderResult.total_characters_count))
        }

        function t(e) {
            "3vs3" === e._type && (o._ladder.updatePageCount(0), o._ladder.updateLadderError())
        }

        function i(e) {
            "3vs3" === e._type && (o._ladder.updatePlayerData([e.ladderResult]), c.displayNonDecimalScorePlayer(o._ladder))
        }

        function n(e) {
            "3vs3" === e._type && o._ladder.updatePlayerError()
        }
        var o = this,
