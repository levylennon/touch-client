function(e, t, i) {
    (function(e, n) {
        ...
        t.debuglog = function(e) {
            ...
            date: "magenta",
            regexp: "red"
        }, t.isArray = f, t.isBoolean = b, t.isNull = m, t.isNullOrUndefined = M, t.isNumber = g, t.isString = _, t.isSymbol = A, t.isUndefined = O, t.isRegExp = v, t.isObject = y, t.isDate = z, t.isError = w, t.isFunction = T, t.isPrimitive = C, t.isBuffer = i(74);
        var x = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"];
        t.log = function() {
            console.log("%s - %s", E(), t.format.apply(t, arguments))
        }, t.inherits = i(75), t._extend = function(e, t) {
            if (!t || !y(t)) return e;
